...
;layui.define(function (e) {
    layui.use(["admin", "carousel"], function () {
        ...
        e.render({
            ...
            url: "http://localhost:8086/test/test1",
            method: "post",
            page: !0,
            ...
            cols: [[{type: "numbers", fixed: "left"}, {
                ...
                title: "标题",
                minWidth: 300,
                templet: '<div><a href="{{ d.href }}" target="_blank" class="layui-table-link">{{ d.keywords }}</div>'
            }, {field: "frequency", title: "发帖者"}, {field: "userNums", title: "类别"}, {
                field: "crt",
                title: "点击率",
                sort: !0
            }]],
